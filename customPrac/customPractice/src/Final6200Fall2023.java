...
public class Final6200Fall2023 {
    ...
    static class ConvertUtil {
        public static int convertToInt(String str) {
            // STUDENT TODO: Implement code to convert string to int using Stream API
        ...
        public static double convertToDouble(String str) {
            // STUDENT TODO: Implement code to convert string to double using Stream API
            return Arrays.stream(str.split(","))
    ...
    static class ItemFactory implements ItemFactoryAPI {
        ...
        public ItemAPI getItem(int id, double price, String name) {
            // STUDENT TODO: Implement code to create and return an Item object using the provided parameters
            Item item = new Item();
            item.setId(id);
            item.setName(name);
            item.setPrice(price);
    ...
    public void demoStream() {
...

        {
            ...
            List<ItemAPI> itemList = Arrays.stream(a)
                    // STUDENT TODO: use Stream operations to map CSV strings to Item objects
                    .map(s -> {
                        String[] parts = s.split(",");
                        int id = ConvertUtil.convertToInt(parts[0]);
                        double price = ConvertUtil.convertToDouble(parts[1]);
                        String name = parts[2];
                        // Use ItemFactory to create Item objects
...

        {
            ...
            List<ItemAPI> itemListWithFactory = Arrays.stream(a)
                    // STUDENT TODO: use Stream operations to map CSV strings to Item objects using Singleton Factory
                    .map(s -> {
                        String[] parts = s.split(",");
                        int id = ConvertUtil.convertToInt(parts[0]);
                        double price = ConvertUtil.convertToDouble(parts[1]);
...

        {
            ...
            List<ItemAPI> sortedItemList = Arrays.stream(a)
                    ...
                    // STUDENT TODO: use Stream operations to sort items by natural order (you may use Comparator if needed)
...
//                    System.out.println();
            List<ItemAPI> itemList = Arrays.stream(a)
                    ...
                    // STUDENT TODO: use Stream operations to sort items by natural order (you may use Comparator if needed)
                    .sorted(Comparator.comparingDouble(ItemAPI::getPrice).reversed()) // Sort by highest price
                    .collect(Collectors.toList());
